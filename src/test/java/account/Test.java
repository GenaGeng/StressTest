...
public class Test {
    public static void main(String[] args) throws Exception {
        ...
        for (int i=1;i<=30;i++) {
            ...
            //第i次重复执行，先生成测试用例
            String path ="E:\\project\\CMT\\StressTest\\src\\test\\java\\account\\numberOf125";
            ...
            int gt = GenTestCase4Account.generate(i);
            GT.add(gt);

            Thread.sleep(5000);

            //然后执行测试用例
            Class<?> clazz = Class.forName("account.numberOf125.TestAll");
        ...
        writeResult2Excel.writeResult("GT","125TC4Account","Account",String.valueOf(125),GT,ET,NUM);
        writeResult2Excel.writeResult("ET","125TC4Account","Account",String.valueOf(125),GT,ET,NUM);
        writeResult2Excel.writeResult("FTime","125TC4Account","Account",String.valueOf(125),GT,ET,NUM);
        writeResult2Excel.writeResult("FMeasure","125TC4Account","Account",String.valueOf(125),GT,ET,NUM);
    }
