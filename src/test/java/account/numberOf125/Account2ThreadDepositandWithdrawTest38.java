...
public class Account2ThreadDepositandWithdrawTest38 extends TestCase{

	Account2ThreadDepositandWithdrawTest38 accountTest;

	@Before
	public void setUp(){

		accountTest = new Account2ThreadDepositandWithdrawTest38();
	}
	...
	public boolean performDepositsAndWithdrawalsAndCheckInvariant(int numThreads) throws Exception {
		Account account = new Account("The Account",2589);
		...
		for (int i = 0; i < numThreads; i++) {
			...
			withdrawalThreads[i] = new Thread(new WithdrawThread(account,1678));
		}
