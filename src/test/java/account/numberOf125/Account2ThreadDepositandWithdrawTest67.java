...
public class Account2ThreadDepositandWithdrawTest67 extends TestCase{

	Account2ThreadDepositandWithdrawTest67 accountTest;

	@Before
	public void setUp(){

		accountTest = new Account2ThreadDepositandWithdrawTest67();
	}
	...
	public boolean performDepositsAndWithdrawalsAndCheckInvariant(int numThreads) throws Exception {
		...
		for (int i = 0; i < numThreads; i++) {
			depositThreads[i] = new Thread(new DepositThread(account,6499));
			withdrawalThreads[i] = new Thread(new WithdrawThread(account,3696));
		}
