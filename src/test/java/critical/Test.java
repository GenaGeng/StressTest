...
public class Test {
    public static void main(String[] args) throws Exception {
        ...
        for (int i=1;i<=30;i++) {
            ...
            //第i次重复执行，先生成测试用例
            String path ="E:\\project\\CMT\\StressTest\\src\\test\\java\\critical\\numberOf1";
            ...
            int gt = GenTestCase4Critical.generate();
            GT.add(gt);

            Thread.sleep(1000);

            //然后执行测试用例
            Class<?> clazz = Class.forName("critical.TestAll");
        ...
        writeResult2Excel.writeResult("GT","TC4Critical","Critical",String.valueOf(1),GT,ET,NUM);
        writeResult2Excel.writeResult("ET","TC4Critical","Critical",String.valueOf(1),GT,ET,NUM);
        writeResult2Excel.writeResult("FTime","TC4Critical","Critical",String.valueOf(1),GT,ET,NUM);
        writeResult2Excel.writeResult("FMeasure","TC4Critical","Critical",String.valueOf(1),GT,ET,NUM);
    }
